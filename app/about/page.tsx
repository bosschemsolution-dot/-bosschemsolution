...
export default function About() {
  ...
  const leadership = [
    { 
      ...
      description: "Visionary leader driving Boss Chem Solution's growth and innovation in automotive cooling solutions.",
      expertise: ["Strategic Planning", "Business Development", "Industry Relations"],
      image: "/images/ceo-rajesh.jpg"
    },
    { 
      name: "Priya Shah", 
      role: "Co-Founder & CTO", 
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[60vh] flex items-center">
        ...
        <div className="absolute inset-0">
          <Image 
            src="/images/IMG-20240813-WA0006.jpg" 
            alt="Boss Chem Solution About" 
            fill
        ...
        <div className="container mx-auto px-4 relative z-10 text-center text-white">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              Boss Chem Solution — Leading Engine Coolant Manufacturer in <span className="text-blue-400">Surat, Gujarat</span>
            </h1>
            
            <p className="text-lg md:text-xl mb-8 leading-relaxed">
              Boss Chem Solution - Premium engine coolant and radiator coolant manufacturer since 2010. ISO certified automotive cooling solutions for cars, trucks, bikes, and industrial vehicles across Gujarat and India.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="lg:mb-16 mb-10">
            <div className="bg-white rounded-2xl p-4 md:p-12 shadow-xl border border-gray-100">
              <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Best Engine Coolant Manufacturer in Surat</h2>
                <p className="md:text-lg text-base text-gray-600 lg:mb-6 mb-4 leading-relaxed">
                  Since 2010, Boss Chem Solution has been Gujarat&apos;s leading engine coolant and radiator coolant manufacturer. 
                  We specialize in premium antifreeze coolant, automotive coolant, and distilled water for battery maintenance. 
                  Our ISO certified manufacturing facility in Surat produces high-quality coolant for cars, bikes, trucks, and industrial vehicles.
                </p>
                <p className="md:text-lg text-base text-gray-600 leading-relaxed">
                  With 15+ years of expertise in automotive cooling solutions, we serve 1,000+ satisfied customers across Gujarat, 
                  Maharashtra, and Rajasthan. Our commitment to quality, innovation, and customer satisfaction makes us the preferred 
                  coolant manufacturer in Surat.
                </p>
          ...
          <div>
            <div className="text-center lg:mb-10 mb-5">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Meet the visionary leaders driving Boss Chem Solution&apos;s mission to deliver excellence in automotive cooling solutions.
              </p>
            </div>
              ...
              {leadership.map((leader, index) => (
                <div key={index} className="bg-white rounded-lg lg:p-8 p-4 shadow-md border border-gray-100 hover:shadow-2xl transition-shadow">
                  <div className="text-center lg:mb-6 mb-4">
                    <div className="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden border-4 border-blue-200 bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center">
