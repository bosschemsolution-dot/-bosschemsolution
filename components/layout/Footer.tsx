    ...
    <footer className="bg-gradient-to-b from-gray-900 to-gray-950 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8 gap-6 lg:mb-10 mb-6">
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-2">
              <li><Link href="/" className="text-white hover:text-blue-400 transition-colors duration-300 block sm:inline-block">Home</Link></li>
              <li><Link href="/products" className="text-white hover:text-blue-400 transition-colors duration-300 block sm:inline-block">Products</Link></li>
              <li><Link href="/about" className="text-white hover:text-blue-400 transition-colors duration-300 block sm:inline-block">About</Link></li>
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex flex-col sm:flex-row">
              ...
              />
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors duration-300 cursor-pointer">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="lg:pt-6 pt-4 border-t border-gray-800 flex justify-between items-center gap-4 sm:flex-row flex-col-reverse">
          <p className="text-white text-sm text-center">&copy; 2025 Boss Chem Solution. All rights reserved.</p>
          <div className="flex flex-wrap justify-center gap-4">
            <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-blue-600 transition-colors duration-300 shadow-lg cursor-pointer">
